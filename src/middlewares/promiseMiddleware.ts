...
const defaultTypes = [REQUEST, SUCCESS, FAIL];
...
export default function promiseMiddleware() {
    const PROMISE_TYPE_SUFFIXES = defaultTypes;
    ...
    return ref => {
        ...
        return next => action => {
            ...
            next({
                ...
                type: [TYPE, _REQUEST].join(PROMISE_TYPE_DELIMITER),
